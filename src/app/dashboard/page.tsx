...
export default function DashboardPage() {
  ...
  if (!authReady) {
    return (
      <div className="px-4 py-24 text-center text-sm text-muted">Checking session…</div>
    );
  }
  ...
  return (
    <Suspense fallback={<div className="px-4 py-24 text-center text-sm text-muted">Loading dashboard…</div>}>
      <MemberDashboard />
    </Suspense>
  );
}
